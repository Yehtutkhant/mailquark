      ...
      <>
        <div className="mx-auto max-w-5xl px-8 sm:mt-10">
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            By using Normal Human you confirm your acceptance of, and agree to
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            ...
            Normal Human application.
          </p>
          <h3 className="mb-5 text-left text-2xl font-semibold text-gray-600">
            3. Unlimited Access Software License with Termination Rights
          </h3>
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            The Normal Human Software License facilitates the acquisition of
            Normal Human software through a single purchase, granting users
            unrestricted and perpetual access to its comprehensive
            functionalities. Tailored for independent creators, entrepreneurs,
            and small businesses, Normal Human empowers users to create
            ...
            distribution and utilization. Opting for the Normal Human Software
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            Due to the nature of digital products, the Normal Human boilerplate
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            It is not warranted that Normal Human will meet your requirements or
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            Normal Human does not give any warranty, guarantee or other term as
            to the quality, fitness for purpose or otherwise of the software.
            Normal Human shall not be liable to you by reason of any
            ...
            costs, expenses or other claims (whether caused by Normal Human's
            ...
            or services by Normal Human. Normal Human shall not be liable or
            ...
            that Normal Human are deemed liable to you for breach of this
            Agreement, you agree that Normal Human's liability is limited to the
            ...
            Normal Human from any and all obligations, liabilities and claims in
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            Normal Human is not responsible for what the user does with the
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            As we continue to improve Normal Human and expand our offerings, the
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            ...
            relationship exists between you and Normal Human as a result of your
            use of these services. You agree not to hold yourself out as a
            representative, agent or employee of Normal Human. You agree that
            Normal Human will not be liable by reason of any representation, act
