      ...
      <>
        <div className="mx-auto max-w-5xl px-8 sm:mt-10">
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            By using Mailquark you confirm your acceptance of, and agree to be
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            ...
            Mailquark application.
          </p>
          <h3 className="mb-5 text-left text-2xl font-semibold text-gray-600">
            3. Unlimited Access Software License with Termination Rights
          </h3>
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            The Mailquark Software License facilitates the acquisition of
            Mailquark software through a single purchase, granting users
            unrestricted and perpetual access to its comprehensive
            functionalities. Tailored for independent creators, entrepreneurs,
            and small businesses, Mailquark empowers users to create compelling
            web pages and online portfolios. This license entails a
            ...
            distribution and utilization. Opting for the Mailquark Software
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            Due to the nature of digital products, the Mailquark boilerplate
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            It is not warranted that Mailquark will meet your requirements or
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            Mailquark does not give any warranty, guarantee or other term as to
            the quality, fitness for purpose or otherwise of the software.
            Mailquark shall not be liable to you by reason of any representation
            ...
            other claims (whether caused by Mailquark's negligence or the
            ...
            Mailquark. Mailquark shall not be liable or deemed to be in breach
            ...
            clauses in this Agreement, in the event that Mailquark are deemed
            liable to you for breach of this Agreement, you agree that
            Mailquark's liability is limited to the amount actually paid by you
            for your services or software, which amount calculated in reliance
            upon this clause. You hereby release Mailquark from any and all
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            Mailquark is not responsible for what the user does with the
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            As we continue to improve Mailquark and expand our offerings, the
          ...
          <p className="mt-5 mb-10 text-justify leading-relaxed text-gray-600">
            ...
            relationship exists between you and Mailquark as a result of your
            use of these services. You agree not to hold yourself out as a
            representative, agent or employee of Mailquark. You agree that
            Mailquark will not be liable by reason of any representation, act or
